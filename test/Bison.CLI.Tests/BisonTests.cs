...
public class BisonTests
{
    ...
    string observationPath = Path.Combine(AppContext.BaseDirectory, "testdata", "bison_observe_cli_db_test.csv");

    string commentPath = Path.Combine(AppContext.BaseDirectory, "testdata", "bison_comment_cli_db_test.csv");
